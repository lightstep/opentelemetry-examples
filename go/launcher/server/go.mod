module github.com/lightstep/opentelemetry-examples/go/launcher/server

go 1.18

require (
	github.com/lightstep/otel-launcher-go v1.8.0
...
require (
	...
	github.com/lightstep/otel-launcher-go/lightstep/sdk/metric v1.8.0 // indirect
	github.com/lightstep/otel-launcher-go/pipelines v1.8.0 // indirect
